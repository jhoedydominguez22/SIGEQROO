...
{
    // Obtiene todos los documentos de la tabla caratulas
    $documents = Caratula::all();
  ...
  public function storeDocument(Request $request)
{
    ...
    try {
        // Extraemos y mapeamos los campos individuales desde el array 'valor_documental'
        ...
        // Eliminamos el campo original para evitar conflictos si no existe en la tabla
