        ...
        <div class="row mb-3">
          ...
          <div class="row mb-3">
            <div class="col-sm-12">
              ...
              <select v-model="area_asignada" id="area_asignada" class="form-control" required>
                ...
                <option value="Departamento de Normatividad Jurídica y Unidad de Transparencia">Departamento de
                  Normatividad Jurídica y Unidad de Transparencia</option>
                <option value="Departamento de Archivo Histórico">Departamento de Archivo Histórico</option>
                <option value="Departamento de Biblioteca y Hemeroteca">Departamento de Biblioteca y Hemeroteca</option>
                <option value="Departamento de Conservación, Restauración y Encuadernación">Departamento de
                  Conservación, Restauración y Encuadernación</option>
                <option value="Departamento de Tecnologías de la Información y Comunicaciones">Departamento de
...
export default {
  ...
  if (!this.nombre || !this.apellido_materno || !this.apellido_paterno || !this.email || !this.password || !this.confirm_password || !this.area_asignada) {
    Swal.fire({
      icon: 'error',
      title: '¡Error!',
